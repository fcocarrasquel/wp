...
= 1.6.21 - Released on 12 May 2021 =

* New: support for WooCommerce 5.3
* Update: YITH plugin framework
* Fix: the endpoint menu doesn't works with wpml

= 1.6.20 - Released on 14 April 2021 =

* New: support for WooCommerce 5.2
* Update: YITH plugin framework
* Fix: fatal error when trying to edit the My Account page with Elementor
* Fix: notice "You are not allowed to create more than x products" was not displayed

= 1.6.19 - Released on 09 March 2021 =

* New: support for WordPress 5.7
* New: support for WooCommerce 5.1
* Update: YITH plugin framework
* Fix: Vendor can't set their invoice company details

= 1.6.18 - Released on 09 February 2021 =

* New: support for WooCommerce 5.0
* Update: YITH plugin framework

= 1.6.17 - Released on 11 January 2021 =

* New: Support for WooCommerce 4.9
* Fix: Style issue on add/edit coupon section
* Fix: Unable to save dismiss Stripe Connect Integration banner
* Fix: Unable to retrieve the original Frontend Manager page with wpml
* Dev: new filter 'yith_wcfm_dashboard_section_title'
* Dev: new filter 'yith_wcfm_orders_section_title'

= 1.6.16 - Released on 10 December 2020 =

* New: Support for WooCommerce 4.8
* New: Support for WordPress 5.6

= 1.6.15 - Released on 09 November 2020 =
...
* Dev: yith_wcfm_order_date_format filter to change the PHP date format in orders list

= 1.6.14 - Released on 13 October 2020 =

* New: Support for WooCommerce 4.6
* Fix: Unable to see file name in edit product page
* Fix: Mobile view for products table
* Fix: Unable to set all Auction fields in edit product page
* Fix: Unable to edit product from order line item
* Dev: add yith_wcfm_before_setup action
* Dev: add yith_wcfm_after_setup action

= 1.6.13 - Released on 16 September 2020 =

* New: Support for WooCommerce 4.5
* New: PDF Invoice support for Vendors (Version  2.0.17 or greater)
* Fix: Empty products list if Multi Vendor module enabled

= 1.6.12 - Released on 18 August 2020 =

* New: Support for WordPress 5.5
* New: Support for WooCommerce 4.4
* Update: Plugin framework
* Fix: Unable to sort vendor's order list
* Fix: Remove canonical link redirect
* Fix: Unable to filter by vendors in products table
* Fix: Unable to set an order in auto draft
* Dev: yith_wcfm_show_custom_fields_on_cpt hook to remove the custom fields section
